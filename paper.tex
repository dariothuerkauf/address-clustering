...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.65\textwidth]{../figures/land_network.png}
...
3. Most successful graph representation learning because does not require participation in specific on-chain event / usage pattern
4. From the various methods Role2Vec best
5. Summarize Final results
6. For researchers -> extend this approach -> apply it to other address sets -> package
7. 
