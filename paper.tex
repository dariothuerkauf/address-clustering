...
\title{Address Clustering Heuristics for Account-Based Blockchain Networks: An Analysis based on a Specific Address Set}
...
\vspace{1em}
%\large{Master Thesis}\\
\Large Address Clustering Heuristics for Account-Based Blockchain Networks: An Analysis based on a Decentraland User Address Set \\
\large \vspace{1em}
Dario Thürkauf \\
\vspace{1em}
\normalsize
